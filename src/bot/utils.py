...
def handle_command(command: str) -> str:
    commands = {
        "start": "Welcome to CryptoTicker! I'm your crypto assistant. Ask me questions about cryptocurrencies or"
                 " specific coins in our database. 🚀 Type /help to see what I can do.",
